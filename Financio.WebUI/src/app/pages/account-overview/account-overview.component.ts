...
export class AccountOverviewComponent implements OnInit {
    ...
    constructor(
        private inMemoryAccountService: InMemoryAccountService,
    ...
    public ngOnInit() {
        this.accounts$ = this.inMemoryAccountService.getAll();
        // this.accounts$ = this.accountService.getAll();
    }

    public searchName() {
        this.accounts$ = this.inMemoryAccountService.findByName(
            this.accountName
        );
    }
    ...
    private deleteAccount() {
        if (this.currentAccount) {
            this.inMemoryAccountService.deleteAccount(this.currentAccount);
            this.accounts$ = this.inMemoryAccountService.getAll();
    ...
    public saveAccount() {
        if (this.accountDetails.isValid) {
            this.inMemoryAccountService.addAccount(this.newAccount);
            this.hideDialog();
            this.messageService.add({
                severity: 'success',
